  ...
  return (
    <header className={`header-container ${isScrolled ? 'scrolled' : ''}`}>
      ...
      <div className="header-base header-large w-full px-4 md:px-10 flex justify-between items-center">
        ...
        {/* LOGO: Increased mobile size to 45px (approx 2x bigger than before) */}
        ...
        {/* LINKS: Increased mobile text to text-base (16px) */}
        <div className='flex items-center gap-4 md:gap-8 text-base md:text-lg font-raleway font-medium'>
      ...
      {/* --- SMALL HEADER (Scroll State) --- */}
      <div className="header-base header-small">
        <div className="w-full h-full relative px-4 md:px-10">
          ...
          <Link href="/" className="absolute" style={{ top: '100%', left: '1.5rem', marginTop: '0.85rem' }}>
            <img src={faviconLogoUrl} alt="PlaceByte Favicon" className="transition-all duration-300 ease-in-out hover:scale-110" style={{ height: '35px' }} />
          </Link>
